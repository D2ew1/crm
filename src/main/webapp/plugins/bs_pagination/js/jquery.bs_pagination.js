...
(function ($) {
    ...
    var methods = {
            ...
            return this.each(function () {
                ...
                if (settings.bootstrap_version == "3") {
                    ...
                    if (settings.showRowsPerPage) {
                        ...
                        html += '<div class="input-group m-3">';
                        html += '<div class="input-group-prepend">';
                        html += '<span class="input-group-text" style="background-color: #ffffff" title="' + rsc_bs_pag.rows_per_page_title + '"><i class="' + settings.navRowsPerPageIconClass + '"></i></span>';
                        html += '</div>';
                    ...
                    if (settings.showGoToPage && settings.visiblePageLinks < settings.totalPages) {
                        ...
                        html += '<div class="input-group m-3">';
                        html += '<div class="input-group-prepend">';
                        html += '<span class="input-group-text" style="background-color: #ffffff" title="' + rsc_bs_pag.go_to_page_title + '"><i class="' + settings.navGoToPageIconClass + '"></i></span>';
                        html += '</div>';
                ...
                // bs4
                elem.find("li").addClass("page-item");
                elem.find("li").find("a").addClass("page-link");
        ...
        getDefaults: function (bootstrap_version) {
            var default_settings = {
                ...
                navListContainerClass: "col-sm-6 col-md-6",
                navListWrapperClass: "",
                navListClass: "pagination m-3",
                navListActiveItemClass: "active",

                navGoToPageContainerClass: "col-sm-4 col-md-4",
                navGoToPageIconClass: "fas fa-arrow-right",
                navGoToPageClass: "form-control col-sm-6",

                navRowsPerPageContainerClass: "col-sm-4 col-md-4",
                navRowsPerPageIconClass: "fas fa-th-list",
                navRowsPerPageClass: "form-control col-sm-6",

                navInfoContainerClass: "col-sm-4 col-md-4",
                navInfoClass: "",
    ...
    var change_page = function (container_id, previous_selection, current_selection, update_nav_items, trigger_change_page) {
        ...
        if (update_nav_items) {
            ...
            // bs4
            elem_nav_list.find("li").addClass("page-item");
            elem_nav_list.find("li").find("a").addClass("page-link");
        ...
        if (s.showRowsInfo && s.showRowsDefaultInfo) {
            var page_first_row = ((s.currentPage - 1) * s.rowsPerPage) + 1,
                ...
                info_html = page_first_row + "-" + page_last_row + " " +
                    rsc_bs_pag.total_rows_label + " " + s.totalRows + " " + rsc_bs_pag.rows_info_records + "<br/>" +
